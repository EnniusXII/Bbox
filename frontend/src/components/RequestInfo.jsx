	...
	useEffect(() => {
		const fetchRequestInfo = async () => {
			try {
				...
				setError(
					'Failed to load request info. You need to log in to see info.'
				);
			} finally {
				setLoading(false);
			}
		...
		<div className='container'>
			...
			{error ? (
				...
				isOwner ? (
					<div>
						<p>
							<strong>Message:</strong> {requestInfo.message}
						</p>
						<p>
						...
						<p>
							<strong>User:</strong> {requestInfo.user}
						</p>
						<p>
							<strong>First Name:</strong> {requestInfo.name}
						</p>
						<p>
							<strong>Last Name:</strong> {requestInfo.lastName}
						</p>
						<p>
							<strong>License Type:</strong>{' '}
							{requestInfo.licenseTypes}
						</p>
						<p>
